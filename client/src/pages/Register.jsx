            ...
            <div>
              ...
              <div className="relative">
                ...
                <select
                  id="role"
                  {...register('role')}
                  className="block w-full pl-11 pr-4 py-3 bg-slate-950/80 border border-slate-800 rounded-xl text-slate-200 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all text-sm appearance-none"
                >
                  <option value="student" className="bg-slate-900">Student (Practice Mode)</option>
                  <option value="admin" className="bg-slate-900">Admin (Creator Mode)</option>
                </select>
              </div>
            </div>
